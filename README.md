...
A live demo of the project is available at [https://toketsmp.pages.dev](https://toketsmp.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `toket smp`)
...
1. Fork the [repository](https://github.com/tuntugombe/toketsmp/fork) on GitHub.
