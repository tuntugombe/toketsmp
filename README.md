...
A live demo of the project is available at [https://ngentotindo.pages.dev](https://ngentotindo.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `ngentot indo`)
...
1. Fork the [repository](https://github.com/tuntugombe/ngentotindo/fork) on GitHub.
